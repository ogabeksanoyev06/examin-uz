<template>
  <div class="login">
    <div class="p-5 bg-white rounded shadow">
      <h4 class="text-xl mb-2 font-bold">Tizimga kirish</h4>
        ...
        <form @submit.prevent="handleSubmit(loginToSystem)">
          <div class="flex flex-col gap-4">
            ...
            <AppInput
              ...
              :appendIcon="true"
              variant="appendIcon"
              rules="required|passwordformat|max:10"
              required
            >
              <template #appendIcon>
                <svg
            ...
            <AppButton color="primary" class="w-full mt-4" type="submit">
              Tizimga kirish
            </AppButton>
          </div>
        </form>
      </VForm>
      <div class="mt-3 text-left flex flex-col gap-6">
        <div class="flex flex-wrap justify-between items-center gap-1">
          <span class="text-sm font-medium"> Profilingiz mavjud emasmi ? </span>
          <NuxtLink to="/auth/register" class="text-sm font-medium">
            Ro'yxatdan o'tish
          </NuxtLink>
        </div>
      </div>
...
import { access_token, refresh_token } from '~/services/tokenService.js';
