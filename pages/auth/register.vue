<template>
  <div class="register">
    <div class="p-5 bg-white rounded shadow">
      <h4 class="text-xl mb-3 font-bold">Ro'yxatdan o'tish</h4>
      <div class="">
          ...
          <form @submit.prevent="handleSubmit(registerToSystem)">
            <div class="flex flex-col space-y-3">
              ...
              <AppInput
                ref="passwordInput"
                inputName="password"
                :inputType="passwordField ? 'text' : 'password'"
              ...
              <AppInput
                ...
                :inputType="passwordConfirmationField ? 'text' : 'password'"
              ...
              <div class="mt-3 text-left flex flex-col gap-6">
                ...
                <div class="flex flex-wrap justify-between items-center gap-1">
                  ...
                  <NuxtLink to="/auth/login" class="text-sm font-medium">
                    Tizimga kirish
                  </NuxtLink>
                </div>
              </div>
...
const confirmationSee = () => {
  passwordConfirmationField.value = !passwordConfirmationField.value;
};
